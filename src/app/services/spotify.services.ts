...
export class SpotifyService {
  ...
  // Gain access token from Spotify to use API
  getAuth = () => {
  ...
  // Gain search results for a query
  ...
  // Gain data about artist that has been chosen to view
  ...
  // Gain the albums about the artist that has been chosen
